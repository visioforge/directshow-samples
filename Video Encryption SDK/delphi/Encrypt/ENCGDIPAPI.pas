...
type
  ...
  {$EXTERNALSYM GPPixelFormat}
  TGPPixelFormat = GPPixelFormat;
...
function GetPixelFormatSize(pixfmt: GPPixelFormat): UINT;
{$EXTERNALSYM IsIndexedPixelFormat}
function IsIndexedPixelFormat(pixfmt: GPPixelFormat): BOOL;
{$EXTERNALSYM IsAlphaPixelFormat}
function IsAlphaPixelFormat(pixfmt: GPPixelFormat): BOOL;
{$EXTERNALSYM IsExtendedPixelFormat}
function IsExtendedPixelFormat(pixfmt: GPPixelFormat): BOOL;
...
function IsCanonicalPixelFormat(pixfmt: GPPixelFormat): BOOL;
...
//----------------------------------------------------------------------------
  ...
  out format: TGPPIXELFORMAT): GPSTATUS; stdcall;
...
//----------------------------------------------------------------------------
  ...
  function GdipCreateBitmapFromScan0(width: Integer; height: Integer;
    stride: Integer; format: GPPIXELFORMAT; scan0: PBYTE;
    out bitmap: GPBITMAP): GPSTATUS; stdcall;
  ...
  function GdipCloneBitmapArea(x: Single; y: Single; width: Single;
    height: Single; format: GPPixelFormat; srcBitmap: GPBITMAP;
  ...
  function GdipCloneBitmapAreaI(x: Integer; y: Integer; width: Integer;
    height: Integer; format: GPPixelFormat; srcBitmap: GPBITMAP;
    out dstBitmap: GPBITMAP): GPSTATUS; stdcall;
  {$EXTERNALSYM GdipCloneBitmapAreaI}

  function GdipBitmapLockBits(bitmap: GPBITMAP; rect: GPRECT; flags: UINT;
    format: GPPixelFormat; lockedBitmapData: PBITMAPDATA): GPSTATUS; stdcall;
