...
//--------------------------------------------------------------------------
  ...
  public
    ...
    function GetPixelFormat: GPPixelFormat;
  ...
  public
    ...
    constructor Create(width, height, stride: Integer; format: TGPPixelFormat; scan0: PBYTE); reintroduce; overload;
    constructor Create(width, height: Integer; format: TGPPixelFormat = PixelFormat32bppARGB); reintroduce; overload;
    ...
    function Clone(rect: TGPRectF; format: TGPPixelFormat): TGPBitmap; overload;
    function Clone(x, y, width, height: Single; format: TGPPixelFormat): TGPBitmap; overload;
    function LockBits(rect: TGPRect; flags: UINT; format: TGPPixelFormat; out lockedBitmapData: TBitmapData): TStatus;
...
function TGPBitmap.Clone(rect: TGPRectF; format: TGPPixelFormat): TGPBitmap;
begin
  result := Clone(rect.X, rect.Y, rect.Width, rect.Height, format);
end;

function TGPBitmap.Clone(x, y, width, height: Single; format: TGPPixelFormat): TGPBitmap;
var
  bitmap: TGPBitmap;
  gpdstBitmap: GpBitmap;
begin
...
function TGPBitmap.LockBits(rect: TGPRect; flags: UINT; format: TGPPixelFormat;
