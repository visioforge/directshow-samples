...
interface
uses
  Windows, Classes, SysUtils, Messages, Graphics, Forms, Controls, ActiveX, ENCDirectShow9,
  ENCDirectDraw, ENCDXSUtil, ComCtrls, MMSystem, Math, Consts, ExtCtrls,
  MultiMon, Dialogs, Registry, SyncObjs, ENCDirect3D9, ENCWMF9;
