...
type
  D3DVALUE = ENCDXTypes.D3DVALUE;
  {$EXTERNALSYM D3DVALUE}
  TD3DValue = ENCDXTypes.TD3DValue;
  PD3DValue = ENCDXTypes.PD3DValue;

  D3DCOLOR = ENCDXTypes.D3DCOLOR;
  {$EXTERNALSYM D3DCOLOR}
  TD3DColor = ENCDXTypes.TD3DColor;

  _D3DVECTOR = ENCDXTypes._D3DVECTOR;
  {$EXTERNALSYM _D3DVECTOR}
  D3DVECTOR = ENCDXTypes.D3DVECTOR;
  {$EXTERNALSYM D3DVECTOR}
  TD3DVector = ENCDXTypes.TD3DVector;
  PD3DVector = ENCDXTypes.PD3DVector;
...
type
  REFERENCE_TIME = ENCDXTypes.REFERENCE_TIME;
  {$EXTERNALSYM REFERENCE_TIME}
  TReferenceTime = ENCDXTypes.TReferenceTime;
  PReferenceTime = ENCDXTypes.PReferenceTime;
