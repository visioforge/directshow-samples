...
{$I VFVCDirectX.inc}
unit VFVCDirectSound;

interface

uses
  Windows, MMSystem, VFVCDXTypes;
...
type
  D3DVALUE = VFVCDXTypes.D3DVALUE;
{$EXTERNALSYM D3DVALUE}
  TD3DValue = VFVCDXTypes.TD3DValue;
  PD3DValue = VFVCDXTypes.PD3DValue;
...
{$EXTERNALSYM DSDEVID_DefaultCapture}
  ...
  DSDEVID_DefaultVoicePlayback
    : TGUID = '{def00002-9c6d-47ed-aaf1-4dda8f2b5c03}';
...
type
  REFERENCE_TIME = VFVCDXTypes.REFERENCE_TIME;
{$EXTERNALSYM REFERENCE_TIME}
  TReferenceTime = VFVCDXTypes.TReferenceTime;
  PReferenceTime = VFVCDXTypes.PReferenceTime;
...
{$EXTERNALSYM IDirectSound}
  ...
  IDirectSound = interface(IUnknown)
    ...
    function CreateSoundBuffer(const pcDSBufferDesc: TDSBufferDesc;
      out ppDSBuffer: IDirectSoundBuffer; pUnkOuter: IUnknown)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundBuffer}
  ...
  IDirectSoundBuffer = interface(IUnknown)
    ...
    function GetCurrentPosition(pdwCurrentPlayCursor, pdwCurrentWriteCursor
...
{$EXTERNALSYM IDirectSoundBuffer8}
  ...
  IDirectSoundBuffer8 = interface(IDirectSoundBuffer)
    ...
    function GetObjectInPath(const rguidObject: TGUID; dwIndex: DWord;
      const rguidInterface: TGUID; out ppObject { IUnknown } )
      : HResult; stdcall;
  end;
...
{$EXTERNALSYM IDirectSound3DListener}
  IDirectSound3DListener = interface(IUnknown)
    ...
    function GetDistanceFactor(out pflDistanceFactor: TD3DValue)
      : HResult; stdcall;
    function GetDopplerFactor(out pflDopplerFactor: TD3DValue)
      : HResult; stdcall;
    function GetOrientation(out pvOrientFront, pvOrientTop: TD3DVector)
      : HResult; stdcall;
    function GetPosition(out pvPosition: TD3DVector): HResult; stdcall;
    function GetRolloffFactor(out pflRolloffFactor: TD3DValue)
      : HResult; stdcall;
    function GetVelocity(out pvVelocity: TD3DVector): HResult; stdcall;
    function SetAllParameters(const pcListener: TDS3DListener; dwApply: DWord)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSound3DBuffer}
  ...
  IDirectSound3DBuffer = interface(IUnknown)
    ...
    function GetConeAngles(var pdwInsideConeAngle, pdwOutsideConeAngle: DWord)
      : HResult; stdcall;
    function GetConeOrientation(out pvOrientation: TD3DVector)
      : HResult; stdcall;
    function GetConeOutsideVolume(out plConeOutsideVolume: Longint)
      : HResult; stdcall;
    ...
    function SetConeOrientation(x, y, z: TD3DValue; dwApply: DWord)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundCapture}
  ...
  IDirectSoundCapture = interface(IUnknown)
    ...
    function CreateCaptureBuffer(const pcDSCBufferDesc: TDSCBufferDesc;
      out ppDSCBuffer: IDirectSoundCaptureBuffer; pUnkOuter: IUnknown)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundCaptureBuffer}
  ...
  IDirectSoundCaptureBuffer = interface(IUnknown)
    ...
    function GetCurrentPosition(pdwCapturePosition, pdwReadPosition: PDWORD)
      : HResult; stdcall;
    function GetFormat(pwfxFormat: PWaveFormatEx; dwSizeAllocated: DWord;
      pdwSizeWritten: PDWORD): HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundCaptureBuffer8}
  ...
  IDirectSoundCaptureBuffer8 = interface(IDirectSoundCaptureBuffer)
    ...
    function GetObjectInPath(const rguidObject: TGUID; dwIndex: DWord;
      const rguidInterface: TGUID; out ppObject { IUnknown } )
      : HResult; stdcall;
    function GetFXStatus(dwFXCount: DWord; pdwFXStatus: PDWORD)
      : HResult; stdcall;
  end;
...
{$EXTERNALSYM IKsPropertySet}
  IKsPropertySet = interface(IUnknown)
    ...
    function _Set(const rguidPropSet: TGUID; ulId: ULONG;
      pInstanceData: Pointer; ulInstanceLength: ULONG; pPropertyData: Pointer;
      ulDataLength: ULONG): HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundFXGargle}
  IDirectSoundFXGargle = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxGargle: TDSFXGargle)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundFXChorus}
  IDirectSoundFXChorus = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxChorus: TDSFXChorus)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundFXFlanger}
  IDirectSoundFXFlanger = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxFlanger: TDSFXFlanger)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundFXDistortion}
  IDirectSoundFXDistortion = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxDistortion: TDSFXDistortion)
      : HResult; stdcall;
    function GetAllParameters(out PDSFXDistortion: TDSFXDistortion)
      : HResult; stdcall;
  end;
...
{$EXTERNALSYM IDirectSoundFXCompressor}
  IDirectSoundFXCompressor = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxCompressor: TDSFXCompressor)
      : HResult; stdcall;
    function GetAllParameters(out PDSFXCompressor: TDSFXCompressor)
      : HResult; stdcall;
  end;
...
{$EXTERNALSYM IDirectSoundFXParamEq}
  IDirectSoundFXParamEq = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxParamEq: TDSFXParamEq)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundFXI3DL2Reverb}
  IDirectSoundFXI3DL2Reverb = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxI3DL2Reverb: TDSFXI3DL2Reverb)
      : HResult; stdcall;
    function GetAllParameters(out PDSFXI3DL2Reverb: TDSFXI3DL2Reverb)
      : HResult; stdcall;
...
{$EXTERNALSYM IDirectSoundFXWavesReverb}
  IDirectSoundFXWavesReverb = interface(IUnknown)
    ...
    function SetAllParameters(const pcDsFxWavesReverb: TDSFXWavesReverb)
      : HResult; stdcall;
    function GetAllParameters(out PDSFXWavesReverb: TDSFXWavesReverb)
      : HResult; stdcall;
  end;
...
{$EXTERNALSYM IDirectSoundCaptureFXNoiseSuppress}
  ...
  IDirectSoundCaptureFXNoiseSuppress = interface(IUnknown)
    ...
    function SetAllParameters(const pcDscFxNoiseSuppress: TDSCFXNoiseSuppress)
      : HResult; stdcall;
    function GetAllParameters(out PDSCFXNoiseSuppress: TDSCFXNoiseSuppress)
      : HResult; stdcall;
    function Reset: HResult; stdcall;
  end;
...
{$EXTERNALSYM IDirectSoundFullDuplex}
  ...
  IDirectSoundFullDuplex = interface(IUnknown)
    ...
    function Initialize(pCaptureGuid, pRenderGuid: PGUID;
      const lpDscBufferDesc: TDSCBufferDesc;
      const lpDsBufferDesc: TDSBufferDesc; hwnd: hwnd; dwLevel: DWord;
...
{$EXTERNALSYM DSFX_I3DL2_ENVIRONMENT_PRESET_PLATE}
  ...
  I3DL2_ENVIRONMENT_PRESET_DEFAULT: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 100; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_DEFAULT}
  I3DL2_ENVIRONMENT_PRESET_GENERIC: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 100; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
    flDecayHFRatio: 0.83; lReflections: - 2602; flReflectionsDelay: 0.007;
    lReverb: 200; flReverbDelay: 0.011; flDiffusion: 100.0; flDensity: 100.0;
    flHFReference: 5000.0);
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_GENERIC}
  I3DL2_ENVIRONMENT_PRESET_PADDEDCELL: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 6000; flRoomRolloffFactor: 0.0; flDecayTime: 0.17;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_PADDEDCELL}
  I3DL2_ENVIRONMENT_PRESET_ROOM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 454; flRoomRolloffFactor: 0.0; flDecayTime: 0.40;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_ROOM}
  I3DL2_ENVIRONMENT_PRESET_BATHROOM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 1200; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_BATHROOM}
  I3DL2_ENVIRONMENT_PRESET_LIVINGROOM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 6000; flRoomRolloffFactor: 0.0; flDecayTime: 0.50;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_LIVINGROOM}
  I3DL2_ENVIRONMENT_PRESET_STONEROOM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 300; flRoomRolloffFactor: 0.0; flDecayTime: 2.31;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_STONEROOM}
  I3DL2_ENVIRONMENT_PRESET_AUDITORIUM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 476; flRoomRolloffFactor: 0.0; flDecayTime: 4.32;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_AUDITORIUM}
  I3DL2_ENVIRONMENT_PRESET_CONCERTHALL: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 500; flRoomRolloffFactor: 0.0; flDecayTime: 3.92;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_CONCERTHALL}
  I3DL2_ENVIRONMENT_PRESET_CAVE: TDSFXI3DL2Reverb = (lRoom: - 1000; lRoomHF: 0;
    flRoomRolloffFactor: 0.0; flDecayTime: 2.91; flDecayHFRatio: 1.30;
    lReflections: - 602; flReflectionsDelay: 0.015; lReverb: - 302;
    flReverbDelay: 0.022; flDiffusion: 100.0; flDensity: 100.0;
    flHFReference: 5000.0);
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_CAVE}
  I3DL2_ENVIRONMENT_PRESET_ARENA: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 698; flRoomRolloffFactor: 0.0; flDecayTime: 7.24;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_ARENA}
  I3DL2_ENVIRONMENT_PRESET_HANGAR: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 1000; flRoomRolloffFactor: 0.0; flDecayTime: 10.05;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_HANGAR}
  I3DL2_ENVIRONMENT_PRESET_CARPETEDHALLWAY: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 4000; flRoomRolloffFactor: 0.0; flDecayTime: 0.30;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_CARPETEDHALLWAY}
  I3DL2_ENVIRONMENT_PRESET_HALLWAY: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 300; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_HALLWAY}
  I3DL2_ENVIRONMENT_PRESET_STONECORRIDOR: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 237; flRoomRolloffFactor: 0.0; flDecayTime: 2.70;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_STONECORRIDOR}
  I3DL2_ENVIRONMENT_PRESET_ALLEY: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 270; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_ALLEY}
  I3DL2_ENVIRONMENT_PRESET_FOREST: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 3300; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_FOREST}
  I3DL2_ENVIRONMENT_PRESET_CITY: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 800; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_CITY}
  I3DL2_ENVIRONMENT_PRESET_MOUNTAINS: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 2500; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_MOUNTAINS}
  I3DL2_ENVIRONMENT_PRESET_QUARRY: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 1000; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_QUARRY}
  I3DL2_ENVIRONMENT_PRESET_PLAIN: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 2000; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_PLAIN}
  I3DL2_ENVIRONMENT_PRESET_PARKINGLOT: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: 0; flRoomRolloffFactor: 0.0; flDecayTime: 1.65;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_PARKINGLOT}
  I3DL2_ENVIRONMENT_PRESET_SEWERPIPE: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 1000; flRoomRolloffFactor: 0.0; flDecayTime: 2.81;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_SEWERPIPE}
  I3DL2_ENVIRONMENT_PRESET_UNDERWATER: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 4000; flRoomRolloffFactor: 0.0; flDecayTime: 1.49;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_UNDERWATER}
  ...
  I3DL2_ENVIRONMENT_PRESET_SMALLROOM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 600; flRoomRolloffFactor: 0.0; flDecayTime: 1.10;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_SMALLROOM}
  I3DL2_ENVIRONMENT_PRESET_MEDIUMROOM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 600; flRoomRolloffFactor: 0.0; flDecayTime: 1.30;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_MEDIUMROOM}
  I3DL2_ENVIRONMENT_PRESET_LARGEROOM: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 600; flRoomRolloffFactor: 0.0; flDecayTime: 1.50;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_LARGEROOM}
  I3DL2_ENVIRONMENT_PRESET_MEDIUMHALL: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 600; flRoomRolloffFactor: 0.0; flDecayTime: 1.80;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_MEDIUMHALL}
  I3DL2_ENVIRONMENT_PRESET_LARGEHALL: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 600; flRoomRolloffFactor: 0.0; flDecayTime: 1.80;
...
{$EXTERNALSYM I3DL2_ENVIRONMENT_PRESET_LARGEHALL}
  I3DL2_ENVIRONMENT_PRESET_PLATE: TDSFXI3DL2Reverb = (lRoom: - 1000;
    lRoomHF: - 200; flRoomRolloffFactor: 0.0; flDecayTime: 1.30;
...
{$EXTERNALSYM GUID_DSFX_STANDARD_ECHO}
  ...
  GUID_DSFX_STANDARD_DISTORTION
    : TGUID = '{ef114c90-cd1d-484e-96e5-09cfaf912a21}';
{$EXTERNALSYM GUID_DSFX_STANDARD_DISTORTION}
  ...
  GUID_DSFX_STANDARD_COMPRESSOR
    : TGUID = '{ef011f79-4000-406d-87af-bffb3fc39d57}';
...
{$EXTERNALSYM GUID_DSFX_STANDARD_PARAMEQ}
  ...
  GUID_DSFX_STANDARD_I3DL2REVERB
    : TGUID = '{ef985e71-d5c7-42d4-ba4d-2d073e2e96f4}';
...
type
  TDSEnumCallbackA = function(lpGuid: PGUID;
    lpcstrDescription, lpcstrModule: PAnsiChar; lpContext: Pointer)
    : BOOL; stdcall;
{$NODEFINE TDSEnumCallbackA}
  TDSEnumCallbackW = function(lpGuid: PGUID;
    lpcstrDescription, lpcstrModule: PWideChar; lpContext: Pointer)
    : BOOL; stdcall;
...
type
  TDirectSoundFullDuplexCreateFunc = function(pcGuidCaptureDevice,
    ...
    out ppDSBuffer8: IDirectSoundBuffer8; pUnkOuter: IUnknown)
    : HResult; stdcall;
...
{$ELSE}
function DirectSoundCreate(lpGuid: PGUID; out ppDS: IDirectSound;
  pUnkOuter: IUnknown): HResult; stdcall; external DirectSoundDll;
{$EXTERNALSYM DirectSoundCreate}
function DirectSoundEnumerateW(lpDSEnumCallback: TDSEnumCallbackW;
  lpContext: Pointer): HResult; stdcall;
  external DirectSoundDll name 'DirectSoundEnumerateW';
{$EXTERNALSYM DirectSoundEnumerateW}
function DirectSoundEnumerateA(lpDSEnumCallback: TDSEnumCallbackA;
  lpContext: Pointer): HResult; stdcall;
  external DirectSoundDll name 'DirectSoundEnumerateA';
{$EXTERNALSYM DirectSoundEnumerateA}
{$IFDEF UNICODE}
function DirectSoundEnumerate(lpDSEnumCallback: TDSEnumCallback;
  lpContext: Pointer): HResult; stdcall;
  external DirectSoundDll name 'DirectSoundEnumerateW';
{$ELSE}
function DirectSoundEnumerate(lpDSEnumCallback: TDSEnumCallback;
...
function DirectSoundCaptureCreate(lpGuid: PGUID;
  out lplpDSC: IDirectSoundCapture; pUnkOuter: IUnknown): HResult; stdcall;
  external DirectSoundDll;
{$EXTERNALSYM DirectSoundCaptureCreate}
function DirectSoundCaptureEnumerateW(lpDSEnumCallback: TDSEnumCallbackW;
  lpContext: Pointer): HResult; stdcall;
  external DirectSoundDll name 'DirectSoundCaptureEnumerateW';
{$EXTERNALSYM DirectSoundCaptureEnumerateW}
...
{$EXTERNALSYM DirectSoundCaptureEnumerateA}
{$IFDEF UNICODE}
function DirectSoundCaptureEnumerate(lpDSEnumCallback: TDSEnumCallback;
  lpContext: Pointer): HResult; stdcall;
  external DirectSoundDll name 'DirectSoundCaptureEnumerateW';
{$ELSE}
function DirectSoundCaptureEnumerate(lpDSEnumCallback: TDSEnumCallback;
...
function DirectSoundCreate8(pcGuidDevice: PGUID; out ppDS8: IDirectSound8;
  pUnkOuter: IUnknown): HResult; stdcall; external DirectSoundDll;
{$EXTERNALSYM DirectSoundCreate8}
function DirectSoundCaptureCreate8(pcGuidDevice: PGUID;
  out ppDSC8: IDirectSoundCapture8; pUnkOuter: IUnknown): HResult; stdcall;
  external DirectSoundDll;
{$EXTERNALSYM DirectSoundCaptureCreate8}
function DirectSoundFullDuplexCreate(pcGuidCaptureDevice, pcGuidRenderDevice
  : PGUID; const pcDSCBufferDesc: TDSCBufferDesc;
  const pcDSBufferDesc: TDSBufferDesc; hwnd: hwnd; dwLevel: DWord;
  out ppDSFD: IDirectSoundFullDuplex8;
  out ppDSCBuffer8: IDirectSoundCaptureBuffer8;
  ...
  external DirectSoundDll;
{$EXTERNALSYM DirectSoundFullDuplexCreate}
function DirectSoundFullDuplexCreate8(pcGuidCaptureDevice, pcGuidRenderDevice
  : PGUID; const pcDSCBufferDesc: TDSCBufferDesc;
  const pcDSBufferDesc: TDSBufferDesc; hwnd: hwnd; dwLevel: DWord;
  out ppDSFD: IDirectSoundFullDuplex8;
  out ppDSCBuffer8: IDirectSoundCaptureBuffer8;
  out ppDSBuffer8: IDirectSoundBuffer8; pUnkOuter: IUnknown): HResult; stdcall;
  external DirectSoundDll name 'DirectSoundFullDuplexCreate';
{$EXTERNALSYM DirectSoundFullDuplexCreate8}
function GetDeviceID(pGuidSrc, pGuidDest: PGUID): HResult; stdcall;
  external DirectSoundDll;
{$EXTERNALSYM GetDeviceID}
// #endif // DIRECTSOUND_VERSION >= 0x0800
...
begin
  ...
  begin
    ...
    begin
      ...
      DirectSoundEnumerateW := GetProcAddress(DirectSoundLib,
        'DirectSoundEnumerateW');
      DirectSoundEnumerateA := GetProcAddress(DirectSoundLib,
        'DirectSoundEnumerateA');
{$IFDEF UNICODE}
      DirectSoundEnumerate := GetProcAddress(DirectSoundLib,
        'DirectSoundEnumerateW');
{$ELSE}
      DirectSoundEnumerate := GetProcAddress(DirectSoundLib,
        'DirectSoundEnumerateA');
{$ENDIF}
      DirectSoundCaptureCreate := GetProcAddress(DirectSoundLib,
        'DirectSoundCaptureCreate');
      DirectSoundCaptureEnumerateW := GetProcAddress(DirectSoundLib,
        'DirectSoundCaptureEnumerateW');
      DirectSoundCaptureEnumerateA := GetProcAddress(DirectSoundLib,
        'DirectSoundCaptureEnumerateA');
{$IFDEF UNICODE}
      DirectSoundCaptureEnumerate := GetProcAddress(DirectSoundLib,
        'DirectSoundCaptureEnumerateW');
{$ELSE}
      DirectSoundCaptureEnumerate := GetProcAddress(DirectSoundLib,
        'DirectSoundCaptureEnumerateA');
{$ENDIF}
      // #if DIRECTSOUND_VERSION >= 0x0800
      DirectSoundCreate8 := GetProcAddress(DirectSoundLib,
        'DirectSoundCreate8');
      DirectSoundCaptureCreate8 := GetProcAddress(DirectSoundLib,
        'DirectSoundCaptureCreate8');
      DirectSoundFullDuplexCreate := GetProcAddress(DirectSoundLib,
        'DirectSoundFullDuplexCreate');
      DirectSoundFullDuplexCreate8 := GetProcAddress(DirectSoundLib,
        'DirectSoundFullDuplexCreate');
