...
namespace VisioForge.DirectShowLib.DES
{
    ...
    /// </summary>
    [Flags]
#pragma warning disable S2345 // Flags enumerations should explicitly initialize all their members
    public enum SFNValidateFlags
#pragma warning restore S2345 // Flags enumerations should explicitly initialize all their members
    {
        None = 0x00000000,
        Check = 0x00000001,
        Popup = 0x00000002,
    ...
    /// From DEXTER_PARAM
    /// </summary>
    [Localizable(false), StructLayout(LayoutKind.Sequential, Pack = 4)]
