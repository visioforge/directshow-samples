...
namespace VisioForge.DirectShowLib
{
    ...
    public enum ExtTransportModes
    {
        ...
        //VisioForge
        PlaySlowFwd6 = ExtDeviceBase.Base + 1001, // Slow forward
        PlaySlowFwd5 = ExtDeviceBase.Base + 1002,
        PlaySlowFwd4 = ExtDeviceBase.Base + 1003,
        PlaySlowFwd3 = ExtDeviceBase.Base + 1004,
        PlaySlowFwd2 = ExtDeviceBase.Base + 1005,
        PlaySlowFwd1 = ExtDeviceBase.Base + 1006,

        PlayFastFwd1 = ExtDeviceBase.Base + 1007, // Fast forward
        PlayFastFwd2 = ExtDeviceBase.Base + 1008,
        PlayFastFwd3 = ExtDeviceBase.Base + 1009,
        PlayFastFwd4 = ExtDeviceBase.Base + 1010,
        PlayFastFwd5 = ExtDeviceBase.Base + 1011,
        PlayFastFwd6 = ExtDeviceBase.Base + 1012,

        PlaySlowRev6 = ExtDeviceBase.Base + 1013, // Slow reverse
        PlaySlowRev5 = ExtDeviceBase.Base + 1014,
        PlaySlowRev4 = ExtDeviceBase.Base + 1015,
        PlaySlowRev3 = ExtDeviceBase.Base + 1016,
        PlaySlowRev2 = ExtDeviceBase.Base + 1017,
        PlaySlowRev1 = ExtDeviceBase.Base + 1018,

        PlayFastRev1 = ExtDeviceBase.Base + 1019, // Fast reverse
        PlayFastRev2 = ExtDeviceBase.Base + 1020,
        PlayFastRev3 = ExtDeviceBase.Base + 1021,
        PlayFastRev4 = ExtDeviceBase.Base + 1022,
        PlayFastRev5 = ExtDeviceBase.Base + 1023,
        PlayFastRev6 = ExtDeviceBase.Base + 1024,

        Reverse = ExtDeviceBase.Base + 939, // Same as Reverse playback
        ReverseFreeze = ExtDeviceBase.Base + 1025, // Pause at reverse playback

        PlaySlowFwdX = ExtDeviceBase.Base + 1026, // Possible response for a trick play
        PlayFastFwdX = ExtDeviceBase.Base + 1027, // Possible response for a trick play
        PlaySlowRevX = ExtDeviceBase.Base + 1028, // Possible response for a trick play
        PlayFastRevX = ExtDeviceBase.Base + 1029, // Possible response for a trick play

        StopStart = ExtDeviceBase.Base + 1030, // Indicate stopping at the begin of a tape
        StopEnd = ExtDeviceBase.Base + 1031, // Indicate stopping at the end of a tape
        StopEmergency = ExtDeviceBase.Base + 1032 // Indicate stopping due to an emergency
    }
...
#pragma warning restore 618
    ...
    [Localizable(false),ComImport, System.Security.SuppressUnmanagedCodeSecurity,
    ...
    public interface IFilterGraph2 : IGraphBuilder
    {
        ...
        [PreserveSig]
        new int RemoveFilter1([In] IBaseFilter pFilter);
