...
namespace VisioForge.DirectShowLib
{
    ...
    public class StreamBufferSink2
    {
    }
    ...
    static public class MediaType
    {
        ...
        public static readonly Guid DVD_ENCRYPTED_PACK = new Guid("ED0B916A-044D-11D1-AA78-00C04FC31D60");
    }
    ...
    static public class MediaSubType
    {
        ...
        public static readonly Guid HDYC = new Guid("43594448-0000-0010-8000-00AA00389B71");

        /// <summary> MEDIASUBTYPE_v210 </summary>
        public static readonly Guid V210 = new Guid("30313276-0000-0010-8000-00AA00389B71");

        /// <summary> MEDIASUBTYPE_r210 </summary>
        public static readonly Guid R210 = new Guid("30313272-0000-0010-8000-00AA00389B71");
        ...
        public static readonly Guid MSS1 = new Guid("3153534D-0000-0010-8000-00AA00389B71");
        public static readonly Guid MSS2 = new Guid("3253534D-0000-0010-8000-00AA00389B71");
        public static readonly Guid WMAudio_Lossless = new Guid("00000163-0000-0010-8000-00AA00389B71");
        public static readonly Guid WMAudioV8 = new Guid("00000161-0000-0010-8000-00AA00389B71");
        public static readonly Guid WMAudioV9 = new Guid("00000162-0000-0010-8000-00AA00389B71");
        public static readonly Guid WMSP1 = new Guid("0000000A-0000-0010-8000-00AA00389B71");
        ...
        public static readonly Guid WMVA = new Guid("41564D57-0000-0010-8000-00AA00389B71");
        public static readonly Guid WMVP = new Guid("50564D57-0000-0010-8000-00AA00389B71");
        public static readonly Guid WVP2 = new Guid("32505657-0000-0010-8000-00AA00389B71");
    }
