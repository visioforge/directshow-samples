...
type
  ...
  TVFFrameEvent = procedure(Frame: TBitmap; StartTime, StopTime: Integer) of object;
  ...
  /// <param name="StartTime">Start time.</param>
  /// <param name="StopTime">Stop time.</param>
  TVFFrameEventH = procedure(Frame: HBitmap; StartTime, StopTime: Integer) of object;
  ...
  /// <param name="StartTime">Start time.</param>
  /// <param name="StopTime">Stop time.</param>
  TVFFrameEventI = procedure(Frame: Integer; StartTime, StopTime: Integer) of object;
  ...
  /// <param name="StartTime">Start time.</param>
  /// <param name="StopTime">Stop time.</param>
  TVFAudioFrameEvent = procedure(Frame: PByte; FrameSize, SampleRate, Channels, BPS, StartTime, StopTime: Integer)
    of object;
  ...
  TVFChangedFrameEventI = procedure(HFrame: Integer; HDiff: Integer; DiffTop, DiffLeft, DiffHeight, DiffWidth,
    FrameHeight, FrameWidth: Integer; DiffPercent: double; ChangedPerc: double) of object;
  ...
  /// <param name="DiffPercent">Difference %.</param>
  /// <param name="ChangedPerc">Changed %.</param>
  TVFChangedFrameEvent = procedure(HDiff, HFrame: HBitmap; DiffTop, DiffLeft, DiffHeight, DiffWidth, FrameHeight,
    FrameWidth: Integer; DiffPercent, ChangedPerc: double) of object;
  ...
  TVFTVTunerTuneChannelsEvent = procedure(SignalPresent: Boolean; Channel: Integer; Frequency: Integer;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseLeftUpEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseRightDownEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseRightUpEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseRightDoubleClickEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseMiddleUpEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseMiddleDoubleClickEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseX1UpEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseX1DoubleClickEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseX2UpEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  /// <param name="Shift">Shift pressed.</param>
  /// <param name="Alt">Alt pressed.</param>
  TVFMouseX2DoubleClickEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt: Boolean) of object;
  ...
  TVFMouseWheelUpEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt, MouseLeft, MouseRight, MouseMiddle, MouseX1,
  ...
  /// <param name="MouseX2">Mouse X2 button pressed.</param>
  /// <param name="Value">Value.</param>
  TVFMouseWheelDownEvent = procedure(X, Y: Integer; Ctrl, Shift, Alt, MouseLeft, MouseRight, MouseMiddle, MouseX1,
    MouseX2: Boolean; Value: Integer) of object;
