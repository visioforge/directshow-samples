...
const
  ...
  CLSID_VFScreenCaptureDD: TGUID = '{0118D5CC-77E4-4199-81B0-548988688261}';
...
const
  ...
  CLSID_VFVLCSource: TGUID = '{3FC97748-7CB6-4195-89DE-0717582A4863}';
...
type
  eAVEncAudioDualMono = (eAVEncAudioDualMono_SameAsInput,
    ...
    // 2-ch output bitstream should not be dual mono
...
type
  eAVDecAudioDualMono = (eAVDecAudioDualMono_IsNotDualMono,
    ...
    // There is no indication in the bitstream
    );
...
const
  IID_IVP8Encoder: TGUID = '{ED311151-5211-11DF-94AF-0026B977EEAA}';
...
type
  IVP8Encoder = interface(IUnknown)
    ['{ED311151-5211-11DF-94AF-0026B977EEAA}']
    /// <summary>
    ...
    function SetAutoAltRef(AutoAltRef: integer): integer; stdcall;

    function GetAutoAltRef(out pAutoAltRef: integer): integer; stdcall;
    ...
    function SetARNRMaxFrames(Frames: integer): integer; stdcall;

    function GetARNRMaxFrames(out pFrames: integer): integer; stdcall;
    ...
    // is the default.
    function SetARNRStrength(Strength: integer): integer; stdcall;

    function GetARNRStrength(out pStrength: integer): integer; stdcall;
    ...
    function SetARNRType(pType: integer): integer; stdcall;

    function GetARNRType(out pType: integer): integer; stdcall;
    ...
    function SetFixedKeyframeInterval(Interval: int64): integer; stdcall;

    function GetFixedKeyframeInterval(out pInterval: int64): integer; stdcall;
    ...
    // Return values:
    // - S_OK when successful.
    function SetCPUUsed(CPUUsed: integer): integer; stdcall;

    function GetCPUUsed(out pCPUUsed: integer): integer; stdcall;
    ...
    // Return values:
    // - S_OK when successful.
    function SetStaticThreshold(StaticThreshold: integer): integer; stdcall;

    function GetStaticThreshold(out pStaticThreshold: integer)
      : integer; stdcall;
    ...
    function SetDecimate(Decimate: integer): integer; stdcall;

    function GetDecimate(out pDecimate: integer): integer; stdcall;
  end;

const
  IID_IVorbisEncodeSettings1: TGUID = '{A4C6A887-7BD3-4b33-9A57-A3EB10924D3A}';

type
  /// <summary>
  /// Vorbis encoder filter interface.
  /// </summary>
  IVorbisEncodeSettings1 = interface(IUnknown)
...
const
  IID_IWebMVorbisEncodeSettings
    : TGUID = '{A4C6A887-7BD3-4b33-9A57-A3EB10924D3A}';

type
  /// <summary>
  /// Vorbis encoder filter interface.
  /// </summary>
  IWebMVorbisEncodeSettings = interface(IUnknown)
    ['{C0976768-B29C-48F2-B1BF-D398281EBEBC}']
    /// <summary>
    /// Sets mode.
    /// </summary>
    /// <param name="quality">
    ...
    /// Returns true if the operation was successful.
    /// </returns>
    function SetMode(quality: BOOL): integer; stdcall;
    ...
    /// Returns true if the operation was successful.
    /// </returns>
    function SetQuality(inQuality: Single): integer; stdcall;
    ...
    /// Returns true if the operation was successful.
    /// </returns>
    function SetBitRate(inBitrate, inMinBitrate, inMaxBitrate: integer)
      : integer; stdcall;
  end;

const
  CLSID_VFWebmSource: TGUID = '{193F7741-E789-4D2F-8546-C132E2E80FB8}';
  CLSID_VFWebmSplit: TGUID = '{A24F64C4-E527-49AD-A150-11C83DBE486C}';
  CLSID_VFWebmMuxer: TGUID = '{25908CCA-6ED3-4FC8-A358-6D30398D15BF}';
  CLSID_VFWebmVP8Encoder: TGUID = '{7B2B9E53-F65D-4967-BE13-66295E90382E}';
  CLSID_VFWebmVP8Decoder: TGUID = '{4C33B713-07EE-4954-AF82-5DE369B2978C}';
  CLSID_VFWebmVorbisEncoder: TGUID = '{F86DC6FF-66F2-4B42-BE37-2EFE9DD4F549}';
  CLSID_VFWebmVorbisDecoder: TGUID = '{4BBE1D6F-CB80-4211-AD00-6A0555EB474F}';

  CLSID_VorbisEncoder1: TGUID = '{5C94FE86-B93B-467F-BFC3-BD6C91416F9B}';
  CLSID_VorbisDecoder1: TGUID = '{05A1D945-A794-44EF-B41A-2F851A117155}';
  ...
  CLSID_VFAudioEnhancer: TGUID = '{DBC661F0-166C-4AC5-A219-C0838F789A2F}';
  ...
  CLSID_VFNetworkStreamerVideoSink
    : TGUID = '{AA6AB4DF-9670-4913-88BB-2CB381C193EE}';
  ...
  CLSID_VFNetworkStreamerVideoSource
    : TGUID = '{AA4DA14E-644B-487A-A7CB-517A390B4BEE}';
