...
type
  ...
  /// <param name="Name">Filter name.</param>
  /// <param name="Intf">Filter interface.</param>
  TVFFilterEventAX = procedure(Name: WideString) of object;
  ...
  /// <param name="StartTime">Start time.</param>
  /// <param name="StopTime">Stop time.</param>
  TVFRGBFrameEvent = procedure(var Frame: TVFRGBFrame; StartTime, StopTime: Integer) of object;
  ...
  TVFH264TargetUsage = (
    ...
    /// Best quality.
    /// </summary>
    H264TargetUsage_BestQuality,

    /// <summary>
    /// Balanced.
    /// </summary>
    H264TargetUsage_Balanced,

    /// <summary>
    /// Best speed.
    /// </summary>
    H264TargetUsage_BestSpeed);
  ...
  // workaround for Borland bug - http://qc.embarcadero.com/wc/qcmain.aspx?d=3239
type
  tagMONITORINFOEXAVF = record
    cbSize: DWORD;
    rcMonitor: TRect;
    rcWork: TRect;
    dwFlags: DWORD;
